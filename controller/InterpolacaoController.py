...
from controller.VMPController import VizinhosMaisProximos
from controller.MDPController import MediaDosPontos
from controller.IDWController import InversoDaDistancia
from models.Pontos import Pontos
from models.Estrutura import Pixel

class InterpolacaoController:
    ...
    def plotagem_matplotlib(self, dados, color):    
        self.color = color
        self.dados = dados   
        grid_de_valores_interpolados = InterpolacaoController.remodelando_valores_interpolados(self.dados,self.xi)
    ...
    def transforma_TIFF(self,dfn, name):
        dfn = InterpolacaoController.gera_data_frame_de_dados()
